...
This is not an enterprise edge design. It is a homelab setup with a clear set of boundaries and a low maintenance cost.
...
## What I would not publish directly

If you write about your own setup, redact real secrets.

That includes:

- gateway tokens
- basic auth hashes
- anything else that is specific enough to be reused or abused

It is fine to show the structure of the config. Just do not publish live credentials.

## Why I like this arrangement

I like this because the responsibilities are clean.
...
Basic auth gives me a straightforward gate at the edge.
