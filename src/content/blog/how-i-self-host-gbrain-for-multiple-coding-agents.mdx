...
Orca, the editor I use with Codex, preserved the HTTP configuration but did not mount the remote tools. For that client I used [`mcp-remote`](https://github.com/geelen/mcp-remote) as a local stdio bridge:
